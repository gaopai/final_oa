    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        <ul class="am-list admin-sidebar-list">
            ...
            <li>
                ...
                <a id="HrManager" name="hr" class="am-cf" data-am-collapse="{target: '#collapse-hr'}"><span
                        class="am-icon-archive am-icon-fw"></span> 人事管理中心 <span id="hr"
                ...
                <c:choose>
                <c:when test="${requestScope.module == 'HrManager' }">
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-hr"></c:when>
                    <c:otherwise>
                    <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-hr">
                        </c:otherwise>
                        </c:choose>
                        <slp:privilege module="statistics" oprator="all">
                            <li><a href="${pageContext.request.contextPath}/system/hr/statistics" class="am-cf menuBtn">
                                图表统计</a></li>
                        </slp:privilege>
                        <slp:privilege module="employeeInfoList" oprator="all">
                            <li><a href="${pageContext.request.contextPath}/system/hr/employeeInfoList"
                                   class="am-cf menuBtn"> 员工信息管理</a></li>
                        </slp:privilege>
                    </ul>
                    </li>
                    </slp:privilege>
                    ...
                    <li class="admin-parent">
                        <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span>个人办公
                            <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
                        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                            <li><a href="${pageContext.request.contextPath}/system/hr/user" class="am-cf"><span
                    ...
                    <li>
                        ...
                        <a id="EmployeeManager" name="employee" class="am-cf"
                           data-am-collapse="{target: '#collapse-employee'}">
                            <span class="am-icon-users am-icon-fw"></span>
                            员工管理中心 <span id="employee" class="am-icon-angle-down am-fr am-margin-right"></span></a>
                        </c:when>
                        <c:otherwise>
                        <a id="EmployeeManager" name="employee" class="am-cf"
                           data-am-collapse="{target: '#collapse-employee'}"><span
                                class="am-icon-users am-icon-fw"></span> 员工管理中心 <span id="employee"
                                                                                      class="am-icon-angle-right am-fr am-margin-right"></span></a>
                        </c:otherwise>
                        </c:choose>
                        ...
                        <c:choose>
                        <c:when test="${requestScope.module == 'EmployeeManager' }">
                        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-employee"></c:when>
                            <c:otherwise>
                            <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-employee">
                                </c:otherwise>
                                </c:choose>
                                <li><a href="${pageContext.request.contextPath}/system/employee/personalInfo"
                                       class="am-cf menuBtn"> 个人资料</a></li>
                                ...
                                <li><a href="${pageContext.request.contextPath}/system/employee/salaryList"
                                       class="am-cf menuBtn"> 工资记录</a></li>
                                <li><a href="${pageContext.request.contextPath}/system/employee/leaveList"
                                       class="am-cf menuBtn"> 请假记录</a></li>
                                <li><a href="${pageContext.request.contextPath}/system/employee/addressList"
                                       class="am-cf menuBtn"> 企业通讯录</a></li>
                            </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <a id="SysManager" name="sys" class="am-cf"
                                   data-am-collapse="{target: '#collapse-sys'}"><span
                                        class="am-icon-gear am-icon-fw"></span> 系统管理中心 <span id="sys"
                                                                                             class="am-icon-angle-down am-fr am-margin-right"></span></a>
                                </c:when>
                                <c:otherwise>
                                <a id="SysManager" name="sys" class="am-cf"
                                ...
                                <c:choose>
                                <c:when test="${requestScope.module == 'SysManager' }">
                                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-sys"></c:when>
                                    <c:otherwise>
                                    <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-sys">
                                        </c:otherwise>
                                        </c:choose>
                                        <slp:privilege module="noticeManager" oprator="all">
                                            <li><a href="${pageContext.request.contextPath}/system/notice/list"
                                                   class="am-cf menuBtn"> 系统公告管理</a></li>
                                        </slp:privilege>
                                        <li><a href="${pageContext.request.contextPath}/system/notice/noReadList"
                                               class="am-cf menuBtn"> 系统公告查看</a></li>
                                    </ul>
                                    </li>
                                    </slp:privilege>
                                    ...
                                    <li class="admin-parent">
                                        ...
                                        <a id="UserSysManager" name="user" class="am-cf"
                                           data-am-collapse="{target: '#collapse-nav'}"><span
                                                class="am-icon-user am-icon-fw"></span> 用户中心 <span id="user"
                                                                                                   class="am-icon-angle-down am-fr am-margin-right"></span></a>
                                        </c:when>
                                        <c:otherwise>
                                        <a id="UserSysManager" name="user" class="am-cf"
                                        ...
                                        <ul class="am-list am-collapse admin-sidebar-sub am-in"
                                            ...
                                            <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav">
                                                ...
                                                <slp:privilege module="roleManager" oprator="find">
                                                    <li>
                                                        <a href="${pageContext.request.contextPath}/system/user/role_list">
                                                            用户角色管理</a></li>
                                                </slp:privilege>
                                                <slp:privilege module="userManager" oprator="find">
                                                    <li>
                                                        <a href="${pageContext.request.contextPath}/system/user/user_list">
                                                            系统用户管理</a></li>
                                                </slp:privilege>
                                                <slp:privilege module="departMentManager" oprator="find">
                                                    <li>
                                                        <a href="${pageContext.request.contextPath}/system/user/dp_list">
                                                            系统部门管理</a></li>
                                                </slp:privilege>
                                            </ul>
                                            </li>
