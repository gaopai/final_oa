                ...
                <form class="am-form m-form-horizontal"
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-10">
                            <div class="am-form-group ">
                                <div class="field">
                                    <textarea rows="10" cols="20" class="xheditor" data-validate="required:公告内容不能为空"
                                              id="content" placeholder="公告内容"
                                              name="content">${data.noticeContent }</textarea>
                                    <input type="hidden" name="id" value="${data.id }">
                                </div>
                            </div>
                        </div>
