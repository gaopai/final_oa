    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            ...
            <div class="am-u-lg-5 am-u-md-15 ">
                <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/system/user/dp_edit"
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8">
                            <div class="am-form-group ">
                                <div class="field">
                                    <input type="text" value="${requestScope.dp.dpName }"
                                           data-validate="required:名称不能为空" id="user-name" name="fn">
                                    <input type="text" id="dp_id" name="fid" data-validate="required:不能为空"
                                           value="${requestScope.dp.id }" style="display: none;"/>
                                </div>
                            </div>
                        </div>
