        ...
        <div class="am-g">
            <div class="am-u-lg-5 am-u-md-15 ">
                <form class="am-form am-form-horizontal"
                      action="${pageContext.request.contextPath}/system/user/role_edit" method="post"
                      submit-method="ajax">
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8">
                            <div class="am-form-group ">
                                <div class="field">
                                    <input type="text" value="${ro.roleName }" data-validate="required:不能为空"
                                           id="role-name" placeholder="角色名称" name="name">
                                    <input type="text" id="role_ID" name="id" data-validate="required:不能为空"
                                           value="${ro.id }" style="display: none;"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8">
                            <div class="am-form-group ">
                                <div class="field">
                                    <input type="text" value="${ro.description }" data-validate="required:不能为空"
                                            ...
                                            <c:forEach items="${requestScope.dpList}" var="p">
                                                <c:choose>
                                                    <c:when test="${p.id == ro.departmentId}">
                                                        <option value="${p.id }"
                                                                selected="selected">${p.dpName }</option>
                                                    </c:when><c:otherwise>
