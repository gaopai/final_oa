                ...
                <form class="am-form" action="${pageContext.request.contextPath}/system/user/pwdreset" method="post">
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8">
                            <div class="am-form-group ">
                                <div class="field">
                                    <input type="password" data-validate="required:密码不能为空" placeholder="原始密码"
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8">
                            <div class="am-form-group ">
                                <div class="field">
                                    <input type="password" data-validate="required:新密码不能为空" placeholder="新密码" id="pwd_s"
                                           name="password">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="am-form-group ">
                                <div class="field">
                                    <input type="password" placeholder="重复密码"
                                           data-validate="required:新密码不能为空,repeat#password:两次密码不一致" id="rePwd">
                                </div>
                            </div>
                        </div>
                        <div class="am-u-sm-3"></div>
                    ...
                    <div class="am-form-group">
                        <div class="am-u-sm-9 am-u-sm-push-3">
                            ...
                            <%@include file="/WEB-INF/jsp/public/tooltip.jsp" %>
                        </div>
                    </div>
                </form>
            </div>
