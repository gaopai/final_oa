...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <form action="${pageContext.request.contextPath}/system/employee/leaveList" method="post" id="form1"
              class="am-form">
            <div class="am-g">
                <div class="am-u-lg-3">
                    <div class="am-input-group am-input-group-secondary am-form-group">
                        <span class="am-input-group-label">开始</span>
                        <input type="text" class="am-form-field" placeholder="请假时间/开始时间"
                ...
                <div class="am-u-lg-3">
                    <div class="am-input-group am-input-group-secondary am-form-group">
                        ...
                        <input type="text" class="am-form-field" placeholder="请假时间/结束时间"
