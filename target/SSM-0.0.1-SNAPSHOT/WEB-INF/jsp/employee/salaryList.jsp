...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <form action="${pageContext.request.contextPath}/system/employee/salaryList" method="post" id="form1"
              class="am-form">
            <div class="am-g">
                <div class="am-u-lg-3">
                    <div class="am-input-group am-input-group-secondary am-form-group">
                        <span class="am-input-group-label">开始</span>
                        <input type="text" class="am-form-field" placeholder="发放时间/开始时间"
                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="startTime"
                               value="${dateEntity.startTime}"/>
                    </div>
                </div>
                <div class="am-u-lg-3">
                    <div class="am-input-group am-input-group-secondary am-form-group">
                        <span class="am-input-group-label">结束</span>
                        <input type="text" class="am-form-field" placeholder="发放时间/结束时间"
                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="endTime"
                               value="${dateEntity.endTime}"/>
                    </div>
                </div>
                <div class="am-u-lg-1">
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main am-text-nowrap">
                            ...
                            <c:forEach items="${list }" var="p" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/system/employee/personalInfo">${p.employeeName}</a>
                                    </td>
