                ...
                <fieldset>
                    ...
                    <div class="am-form-group">
                        <label for="name">员工姓名：</label> <input type="text" id="name" value="${info.name }"
                                                               name="name" minlength="2" placeholder="输入用户名（至少 3 个字符）"
                                                               required/>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label for="qqNumber">qq号：</label> <input type="text" value="${info.qqNumber }"
                                                                  id="qqNumber" name="qqNumber" placeholder="输入qq号"
                                                                  required/>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label for="age">年龄：</label> <input type="number" name="age" value="${info.age }"
                                                            id="age" placeholder="输入年龄  18-70" min="18" max="70"
                                                            required/>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label for="entryTime">入职时间：</label> <input type="text"
                                                                    ...
                                                                    name="entryTime"
                                                                    value="<fmt:formatDate value="${info.entryTime }" pattern="yyyy-MM-dd"/>"
                                                                    required/>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label for="baseSalary">基本工资：</label> <input type="number"
                                                                     id="baseSalary" name="baseSalary"
                                                                     value="${info.baseSalary }" placeholder="输入基本工资"
                                                                     required/>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label for="performance">绩效工资：</label> <input type="number"
                                                                      ...
                                                                      value="${info.performance }" placeholder="输入绩效工资"
                                                                      required/>
                    </div>
                    ...
                    <div class="am-form-group">
                        <label for="positionSalary">岗位工资：</label> <input type="number" value="${info.positionSalary }"
                                                                         id="positionSalary" name="positionSalary"
                                                                         placeholder="输入岗位工资"
                                                                         required/>
                    </div>
