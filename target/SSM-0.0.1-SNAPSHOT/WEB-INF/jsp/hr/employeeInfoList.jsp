...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <form action="${pageContext.request.contextPath}/system/hr/employeeInfoList" method="post" id="form1"
              class="am-form">
            <div class="am-g">
                <slp:privilege module="HrManager" oprator="add">
                    <div class="am-u-lg-2">
                        <div class="am-input-group am-input-group-secondary am-form-group">
                            <a href="${pageContext.request.contextPath}/system/hr/addEmployeeInfo"><span
                ...
                <div class="am-u-lg-3">
                    <div class="am-input-group am-input-group-secondary am-form-group">
                        ...
                        <input type="text" name="name" placeholder="员工姓名" value="${employeeInfo.name}"
                               class="am-form-field"/>
                    </div>
                </div>
                <div class="am-u-lg-3">
                                        ...
                                        <ul class="am-dropdown-content">
                                            <slp:privilege module="userManager" oprator="add">
                                                <c:if test="${p.userName == null || p.userName == ''}">
                                                    <li>
                                                        <a href="${pageContext.request.contextPath}/system/user/user_add_init?pid=${p.id}">创建账户</a>
                                                    </li>
                                                </c:if>
                                            </slp:privilege>
