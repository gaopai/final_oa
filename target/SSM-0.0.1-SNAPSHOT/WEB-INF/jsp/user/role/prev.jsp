...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/system/user/role_prev_sbmt"
              method="post">
                ...
                <c:forEach items="${requestScope.prevs }" var="p" varStatus="status">
                    <tr>
                        <td width="15%" style="vertical-align: middle;">
                            <small>
                                <input type="checkbox"
                                       lang="pre_${status.index }" name="prevId" value="${p.id }"/> ${p.prevName }
                            </small>
                        </td>
                        <td>
                            <table class="am-table">
                                        ...
                                        <td style="vertical-align: middle;">
                                            <small class="am-text-primary ">
                                                <input type="checkbox"
                                                       ...
                                                       class="pre_${status.index }" name="prevId"
                                                       value="${ps.id }"/> ${ps.prevName }</small>
                                        </td>
                                        <td>
            ...
            <div class="am-form-group">
                <div class="am-u-sm-10 am-u-sm-offset-2">
                    <input type="submit" class="am-btn am-btn-primary" value="授权"/>
                    <%@include
