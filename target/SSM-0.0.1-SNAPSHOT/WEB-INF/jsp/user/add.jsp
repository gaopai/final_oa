                    ...
                    <div class="am-tab-panel am-fade am-in am-active" id="tab2">
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-7">
                                <div class="am-form-group ">
                                    <div class="field">
                                        <input type="text" name="nickName" data-validate="required:用户昵称不能为空"
                                               placeholder="用户昵称">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-7">
                                <div class="am-form-group ">
                                    <div class="field">
                                        <input type="password" id="pwd_s" name="pd" data-validate="required:密码不能为空"
                                               placeholder="用户密码">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-7">
                                <div class="am-form-group ">
                                    <div class="field">
                                        <input type="password" data-validate="required:密码不能为空,repeat#pd:两次密码输入不一致"
                                               placeholder="重复密码">
                                    </div>
                                </div>
                            </div>
