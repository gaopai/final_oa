...
<div class="am-g">
    <div class="am-u-lg-4 am-u-md-8 am-u-sm-centered">
        <form method="post" class="am-form" action="${pageContext.request.contextPath}/system/user/login">
            ...
            <div class="am-form-group ">
                <div class="field am-input-group am-input-group-primary">
                    <input type="password" name="pd" id="pd" value="" placeholder="登陆密码"
            ...
            <div class="am-form-group">
                <div class="field am-input-group am-input-group-primary">
                    ...
                    <span class="am-input-group-btn"><img id="captchaImage" class="captchaImage"
                                                          src="${pageContext.request.contextPath}/system/user/check_code"/></span>
                </div>
            </div>
            <br/>
            <div class="am-cf">
