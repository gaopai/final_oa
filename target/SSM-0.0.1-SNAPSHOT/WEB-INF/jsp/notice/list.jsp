                ...
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <c:forEach items="${list }" var="p">
                            <tr>
                                <td>${p.id}</td>
                                <td><a href="javascript:void(0);" class="content-show" id="${p.id}"
                                       name="${p.userId}">${p.title}</a><span
                                        style="display:none;">${p.noticeContent}</span></td>
                                <td>${p.nickName}</td>
                                    ...
                                    <div class="am-dropdown" data-am-dropdown>
                                        ...
                                        <ul class="am-dropdown-content">
                                            <slp:privilege module="noticeManager" oprator="publish">
                                                <li><a href="javascript:void(0);" lang="${p.id }" class="publish">发布</a>
                                                </li>
                                            </slp:privilege>
                                            <slp:privilege module="noticeManager" oprator="update">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/system/notice/updateInit?id=${p.id}">修改</a>
                                                </li>
                                            </slp:privilege>

                                            <slp:privilege module="noticeManager" oprator="delete">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/system/notice/delete?id=${p.id}&currentPage=${requestScope.page.currentPage }">删除</a>
                                                </li>
                                            </slp:privilege>
                                        </ul>
                                    </div>
