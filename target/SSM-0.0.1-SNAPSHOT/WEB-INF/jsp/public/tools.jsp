...
<div class="am-alert am-alert-success" style="width: 50%;margin-left: 25%;top: 6px;position: absolute;display: none;"
     data-am-alert>
    <p style="text-align: center;" id="wz"></p>
</div>

<div class="am-alert am-alert-danger" style="width: 50%;margin-left: 25%;top: 6px;position: absolute;display: none;"
     data-am-alert>
